const showMoviePage = async () => {
    ...
    const response1 = await axios.get(`http://disabilityscene.com/api/casts/movieId/${movieId0}`)
    ...
    const response2 = await axios.get(`http://disabilityscene.com/api/reviews/movieId/${movieId0}`)
