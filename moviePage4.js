const showMoviePage = async () => {
    ...
    const response1 = await axios.get(`https://disabilityscene.com/api/casts/movieId/${movieId4}`)
    ...
    const response2 = await axios.get(`https://disabilityscene.com/api/reviews/movieId/${movieId4}`)
