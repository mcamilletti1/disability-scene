const showMoviePage = async () => {
    const response = await axios.get('https://disabilityscene.com/movies')
    const allMovies = response.data
    const movieId2 = allMovies[2]._id
    const response1 = await axios.get(`https://disabilityscene.com/casts/movieId/${movieId2}`)
    ...
    const response2 = await axios.get(`https://disabilityscene.com/reviews/movieId/${movieId2}`)
