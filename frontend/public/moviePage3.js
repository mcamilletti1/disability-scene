const showMoviePage = async () => {
    ...
    const response1 = await axios.get(`disability-scene-api-production.up.railway.app/api/movies/${movieId3}/cast`)
    ...
    const response2 = await axios.get(`disability-scene-api-production.up.railway.app/api/movies/${movieId3}/reviews`)
