...
const showAllMovies = async () => {
    ...
    const response3 = await axios.get(`disability-scene-api-production.up.railway.app/api/movies/${mostRecentId}/reviews`)
    ...
    for (let i=0; i < moviesLength; i++) {
        ...
        movieList.innerHTML += `<li><a href="moviePage${i}.html"><img class="individualImage" aria-hidden="true" width="203px" height="258px" src="${allMovies[i].img}"> <p class="individualTitle">${allMovies[i].title}</p></a></li>`
    }
    ...
    const getFeaturedSceneScore = async () => {
        ...
        if (featuredCastingScore <= 0.5) {
            ...
            casting.HTML = `Authentic Casting: <img src="images/half-star-icon-design-isolated-on-white-background-vector.jpg" width="14px" height="11px" alt="4.5 Stars"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/half-star-icon-design-isolated-on-white-background-vector.jpg" width="14px" height="11px" aria-hidden="true"/>`
        } else {
            casting.HTML = `Authentic Casting: <img src="images/star.svg" width="14px" height="11px" alt="Five Stars"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/>`
        }
        ...
        if (featuredOriginalityScore <= 0.5) {
            ...
            originality.HTML = `Originality: <img src="images/half-star-icon-design-isolated-on-white-background-vector.jpg" width="14px" height="11px" alt="4.5 Stars"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/half-star-icon-design-isolated-on-white-background-vector.jpg" width="14px" height="11px" aria-hidden="true"/>`
        } else {
            originality.HTML = `Originality: <img src="images/star.svg" width="14px" height="11px" alt="Five Stars"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/>`
        }
        ...
        if (featuredAccuracyScore <= 0.5) {
            ...
            accuracy.HTML = `Accuracy: <img src="images/half-star-icon-design-isolated-on-white-background-vector.jpg" width="14px" height="11px" alt="4.5 Stars"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/half-star-icon-design-isolated-on-white-background-vector.jpg" width="14px" height="11px" aria-hidden="true"/>`
        } else {
            accuracy.HTML = `Accuracy: <img src="images/star.svg" width="14px" height="11px" alt="Five Stars"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="images/star.svg" width="14px" height="11px" aria-hidden="true"/>`
        }
