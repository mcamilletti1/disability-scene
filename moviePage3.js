const showMoviePage = async () => {
    ...
    const response1 = await axios.get(`https://disabilityscene.com/api/casts/movieId/${movieId3}`)
    ...
    const response2 = await axios.get(`https://disabilityscene.com/api/reviews/movieId/${movieId3}`)
