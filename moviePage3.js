const showMoviePage = async () => {
    ...
    const response1 = await axios.get(`http://localhost:3001/api/casts/movieId/${movieId3}`)
    ...
    const response2 = await axios.get(`http://localhost:3001/api/reviews/movieId/${movieId3}`)
