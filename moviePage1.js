const showMoviePage = async () => {
    ...
    const response1 = await axios.get(`http://localhost:3001/api/casts/movieId/${movieId1}`)
    ...
    const response2 = await axios.get(`http://localhost:3001/api/reviews/movieId/${movieId1}`)
