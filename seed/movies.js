...
const main = async () => {
    const movies = [
        ...
        },
        {
            ...
            duration: 82,
            actors: ["John Gallagher Jr.", "Kate Siegel", "Michael Trucco", "Samantha Sloyan", "Emma Graves", "Mike Flanagan", "Mike Flanagan", "Kate Siegel", "Jason Blum", "Trevor Macy", "Jeanette Volturno", "Michael J. Fourticq Sr.", "Kate Lumpkin", "Couper Samuelson", "The Newton Brothers", "James Kniest", "Mike Flanagan", "Elizabeth Boller", "Jean Childs"],
