const showMoviePage = async () => {
    ...
    const movieId4 = allMovies[4]._id
    const response1 = await axios.get(`http://localhost:3001/api/casts/movieId/${movieId4}`)
    ...
    const response2 = await axios.get(`http://localhost:3001/api/reviews/movieId/${movieId4}`)
    ...
    movieTitle.innerHTML = `${allMovies[4].title} (${allMovies[4].year})`
    movieDateGenreDuration = document.querySelector('#dateGenreDuration')
    movieDateGenreDuration.innerHTML = `${allMovies[4].year} | ${allMovies[4].genre} | ${allMovies[4].duration} mins`
    movieDescription = document.querySelector('#movieDescription')
    movieDescription.innerHTML = `${allMovies[4].description}`
    movieImage = document.querySelector('#column1')
    movieImage.innerHTML = `<img id="moviePoster" src="${allMovies[4].img}" width="203px" height="300px" alt="Movie Poster"/>`
    const disabilities = document.querySelector('#disabilities')
    disabilities.innerHTML = `${allMovies[4].disabilities.toString()}`
    const themes = document.querySelector('#themes')
    themes.innerHTML = `${allMovies[4].themes.toString()}`
    const genre = document.querySelector('#genre')
    genre.innerHTML = `${allMovies[4].genre.toString()}`
    const getSceneScore = async () => {
        ...
        if (OriginalityScore <= 0.5) {
            ...
            originality.innerHTML = `Originality: <img src="file:///Users/margaretcamilletti/Downloads/half-star-icon-design-isolated-on-white-background-vector.jpg" width="14px" height="11px" alt="4.5 Stars"/><img src="file:///Users/margaretcamilletti/Downloads/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="file:///Users/margaretcamilletti/Downloads/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="file:///Users/margaretcamilletti/Downloads/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="file:///Users/margaretcamilletti/Downloads/half-star-icon-design-isolated-on-white-background-vector.jpg" width="14px" height="11px" aria-hidden="true"/>`
        } else {
        ...
        if (AccuracyScore <= 0.5) {
            ...
            accuracy.innerHTML = `Accuracy: <img src="file:///Users/margaretcamilletti/Downloads/half-star-icon-design-isolated-on-white-background-vector.jpg" width="14px" height="11px" alt="4.5 Stars"/><img src="file:///Users/margaretcamilletti/Downloads/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="file:///Users/margaretcamilletti/Downloads/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="file:///Users/margaretcamilletti/Downloads/star.svg" width="14px" height="11px" aria-hidden="true"/><img src="file:///Users/margaretcamilletti/Downloads/half-star-icon-design-isolated-on-white-background-vector.jpg" width="14px" height="11px" aria-hidden="true"/>`
        } else {
